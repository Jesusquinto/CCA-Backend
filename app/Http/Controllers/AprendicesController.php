...
class AprendicesController extends Controller
{
     ...
     function get_aprendices_by_ficha_and_instructor($ficha){
         $user = JWTAuth::parseToken()->authenticate(); 
         $aprendices_activados = Aprendices::with(['usuario', 'ficha'])->where('ficha', $ficha)->where('estado', 0)->get();
         $aprendices_no_activados = Aprendices::with(['usuario', 'ficha'])->where('ficha', $ficha)->where('estado', 1)->get();

         return response()->json([
            'aprendicesActivos' => $aprendices_activados,
            'aprendicesNoActivos' => $aprendices_no_activados
            ], 200);
      } 


      function activar_desactivar_aprendiz($id){
